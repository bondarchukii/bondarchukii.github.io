...
Вообще говоря, первоначально она появилась как результат изучения реальных физических задач и построения моделей. Однако в теории вероятностей про физику(т.е. механику) как-то забыли: на основе аксиоматической теории определе формальный путь, что привело к немалому числу ошибок.
